...
def keys_per_scientist(n_scientists, min_present):
    from math import comb
    # Cada cientista deve ter a quantidade de chaves igual ao número de cadeados
    return comb(n_scientists - 1, min_present - 1)

# Exemplo para 9 cientistas e pelo menos 5 presentes
print("Número de chaves que cada cientista deve ter:", keys_per_scientist(n_scientists, min_present))
